...
router.post('/', (0, permissions_1.hasPermission)('manage_pumps'), (0, validation_1.validate)(pump_schema_1.createPumpSchema), planLimits_1.checkPumpLimit, pumpController.createPump);
// Enforce permission for getting, updating, deleting pumps
router.get('/:id', (0, permissions_1.hasPermission)('manage_pumps'), pumpController.getPumpById);
router.patch('/:id', (0, permissions_1.hasPermission)('manage_pumps'), pumpController.updatePump);
router.delete('/:id', (0, permissions_1.hasPermission)('manage_pumps'), pumpController.deletePump);
// Get pumps by station ID (view permission)
router.get('/station/:stationId', (0, permissions_1.hasPermission)('manage_pumps'), pumpController.getPumpsByStationId);
