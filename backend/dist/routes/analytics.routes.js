...
router.get('/tenant', auth_1.authenticateJWT, tenant_1.setTenantContext, analyticsController.getTenantSalesAnalytics);
// SuperAdmin: global analytics dashboard
router.get('/global', auth_1.authenticateJWT, superadmin_1.requireSuperAdmin, analyticsController.getGlobalAnalytics);
